                            ...
                            <form method="POST" action="{{ route('events.update', $event->id) }}"
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" name="name" class="form-control" id="inputEventeName" value="{{$event->name}}"
                                            required placeholder="Event Name">
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label" for="inputAddress">Address</label>
                                        <input type="text" name="address" class="form-control" id="inputAddress" required value="{{$event->address}}"
                                            placeholder="Address">
                                    </div>
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-3">
                                        ...
                                        <input type="text" name="place" class="form-control" id="inputPlace" required value="{{$event->place}}"
                                            placeholder="Place">
                                    </div>
                                    <div class="mb-3 col-md-3">
                                        <label class="form-label" for="inputDate">Date</label>
                                        <input type="date" name="date" class="form-control" id="inputDate" required value="{{$event->date}}"
                                            placeholder="Date">
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label class="form-label" for="inputStartTime">Start Time</label>
                                        <div class="input-group ">
                                            <input type="time" name="startTime" id="inputStartTime" class="form-control" value="{{$event->startTime}}" 
                                    ...
                                    <div class="mb-3 col-md-3">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="time" name="finishTime" id="inputFinishTime" value="{{$event->finishTime}}"
