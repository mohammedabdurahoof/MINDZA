                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="{{ route('events.create') }}" class="btn btn-primary btn-lg"><i
                                        class="align-middle" data-feather="plus"></i>Add Event</a>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-action">
                                            <form action="{{ route('events.destroy', $event->id) }}" method="POST">
                                                ...
                                                <a class="btn btn-primary" href="{{ route('events.edit', $event->id) }}"><svg
